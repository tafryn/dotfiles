    ...
    -- zoom
    vim.api.nvim_set_keymap("n", "<leader>z", ":call QuarterFocus()<CR>",
                            {noremap = true, silent = true})

    -- project search
    vim.api.nvim_set_keymap("n", "<leader>?", ":CtrlSF <C-R>=expand(\"<cword>\")<CR><CR>",
                            {noremap = true, silent = true})
    vim.api.nvim_set_keymap("v", "<leader>?", "y:CtrlSF <C-R>\"<CR><CR>",
                            {noremap = true, silent = true})

    -- switch buffer
    vim.api.nvim_set_keymap("n", "<leader>m", ":CMakeBuild -j8<CR>",
                           {noremap = true, silent = true})
    ...
    local mappings = {
        ...
        g = {
            name = "Git",
            n = {"<cmd>lua require 'lv-utils'.next_hunk()<cr>", "Next Hunk"},
            p = {"<cmd>lua require 'lv-utils'.prev_hunk()<cr>", "Prev Hunk"},
